...
export const securityGrcCompanies: CompanyRecord[] = [
  /* ---------------------------------------------------------------------- */
  {
    slug: 'cyera',
    name: 'Cyera',
    website: 'https://www.cyera.com',
    headquarters: 'New York, New York, United States, with research and development in Tel Aviv, Israel',
    foundedYear: 2021,
    ...
    capitalFit: {
      ...
      blended: {
        rating: 1,
        drivers: [
          'No blended requirement is visible in the public record',
        ],
        conditions:
...
modi.sahil@gmail.com`,
        ...
        {
          audience: 'CFO',
          recipientRole: 'Matt Kunkel, co-founder and Executive Chairman, publicly focused on capital strategy',
