...
export const emergingCompanies: CompanyInput[] = [
  /* ---------------------------------------------------------------------- */
  {
    ...
    totalDisclosedFunding: 'Approximately USD 200 million across disclosed rounds',
    investors: [
    ...
    customerEvidence: claim(
      'Company sources state more than 1,000 paying customers as of early 2025, up from approximately 200 in June 2022, naming Anthropic, OpenAI, Cursor, Perplexity, Replit, and Vercel among them.',
      'company-reported',
      ['wos-sacra', 'wos-b'],
      true,
    ),
    commercialMaturitySignal: claim(
      'Seven years of operation, more than 1,000 paying customers, named adoption by several of the largest AI application companies, and a Series C led by two institutional growth investors.',
      'company-reported',
      ['wos-sacra', 'wos-c'],
      true,
    ),
    growthSignal: claim(
      'Company sources state paying customers rose from approximately 200 in June 2022 to more than 1,000 by early 2025, and that annual recurring revenue reached USD 30 million by October 2025.',
      'company-reported',
      ['wos-sacra'],
      true,
    ),
    recurringRevenueEvidence: claim(
      'Revenue is discussed by the chief executive in annual recurring revenue terms against a subscription contract base priced by connection and seat.',
      'company-reported',
      ['wos-sacra'],
      false,
    ),
    ...
    arrEvidence: claim(
      'Annual recurring revenue of approximately USD 30 million as of October 2025, stated by the chief executive in a published research interview.',
      'company-reported',
      ['wos-sacra'],
      true,
    ),
    capitalEfficiencyEvidence: claim(
      'Approximately USD 30 million of annual recurring revenue supported by a stated headcount of roughly 95 employees, which is an unusually high revenue per employee ratio for a company at this stage.',
      'company-reported',
      ['wos-sacra'],
      true,
    ),
    ...
    mainFinancialRisk:
      'A reported USD 2 billion valuation against approximately USD 30 million of stated ARR implies a demanding forward multiple that leaves no room for a growth slowdown.',
    mainTechnologyRisk:
    ...
    whyEnteredPipeline:
      'The revenue per employee ratio is the signal. Roughly USD 30 million of ARR on about 95 people is a structurally different operating model from most companies at this valuation, and capital efficiency of that kind is exactly what makes a non dilutive conversation credible rather than theoretical.',
    whyMayNeedGrowthCapital:
      'The company has just raised, so near term need is low. The interesting question is the inverse: a business this efficient generates the debt service capacity that most companies at its stage do not have, which makes it a candidate for a structure conversation ahead of its next equity event rather than during one.',
    ...
    whyDebtMayFit:
      'Stated ARR of approximately USD 30 million with roughly 95 employees implies a cost base small enough that debt service is plausible. That is an inference from two disclosed figures rather than a confirmed cash flow, and it sits at the lower boundary of where recurring revenue facilities begin.',
    whyBlendedMayFit:
      'At a reported USD 2 billion valuation, every point of dilution is expensive. A company with this revenue per employee ratio is precisely the profile where a modest facility can fund growth at a fraction of the ownership cost.',
    preliminaryCapitalView:
      'Analyst judgment. Growth equity is the demonstrated structure. Private credit is potentially suitable at a modest size, subject to confirming ARR on a contracted basis, gross margin, net and gross retention, burn, cash balance, and debt service capacity, and to the company being willing to accept covenants it has never carried.',

    outreachPriority: 'High',
    qualificationQuestions: [
      'Approximately USD 30 million of ARR on roughly 95 employees is a distinctive ratio. Is the business at or near cash flow breakeven, and is that a deliberate constraint or an outcome?',
    ...
    nextDiligenceStep:
      'Establish contracted ARR against usage revenue, and customer concentration across the top ten accounts. In a business selling to a single fast growing customer segment, concentration is the dominant risk and it is entirely undisclosed.',
    missingInformation: [
      'Gross margin',
    ...
    factors: {
      mandateFit: rate(5, 'B2B enterprise software infrastructure sold on subscription to engineering and product buyers at software companies.', ['wos-sacra'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(4, 'More than 1,000 paying customers, approximately USD 30 million stated ARR, and named adoption by Anthropic, OpenAI, Cursor, Perplexity, Replit, and Vercel.', ['wos-sacra', 'wos-b'], 'company-reported', 'Moderate', 'Customer count and named logos are strong for a company of this age. Revenue scale is modest relative to the benchmark set, which is what holds this below a 5.'),
      growthQuality: rate(4, 'Customer count disclosed at two dated points, approximately 200 in June 2022 rising above 1,000 by early 2025, alongside a stated ARR figure for October 2025.', ['wos-sacra', 'wos-b'], 'company-reported', 'Moderate', 'Growth is evidenced on two independent measures across dated periods. Held below 5 because the disclosures come from an interview rather than a formal announcement and no growth rate is stated directly.'),
      recurringRevenueQuality: rate(3, 'ARR stated by the chief executive against a subscription contract base. No retention measure of any kind is published.', ['wos-sacra'], 'company-reported', 'Moderate', 'Scale is disclosed, which lifts this above a bare subscription claim. Retention is entirely absent.'),
      customerDurability: rate(4, 'Identity and directory infrastructure sits in the authentication path of the customer product, so replacement is a migration rather than a switch. More than 1,000 customers implies reasonable breadth.', ['wos-sacra'], 'analyst-judgment', 'Moderate', 'Very high technical switching cost once embedded. Held below 5 because the customer base is concentrated in one fast moving segment and large customers can rebuild identity internally.'),
      marketAttractiveness: rate(4, 'Every software company selling upmarket hits the same enterprise procurement checklist, and the volume of companies making that transition has risen with AI application growth.', ['wos-sacra'], 'analyst-judgment', 'Moderate', 'A structural and repeating need with a clear trigger event. Held below 5 because the buy against build decision is genuinely contested and the alternative is free engineering time.'),
      capitalEfficiency: rate(5, 'Approximately USD 30 million of stated ARR supported by roughly 95 employees, against approximately USD 200 million raised across disclosed rounds.', ['wos-sacra'], 'company-reported', 'Moderate', 'Revenue per employee at this level is the strongest capital efficiency evidence in the emerging set, and it is the specific reason this company is in the universe.'),
      capitalNeedTiming: rate(2, 'A USD 100 million Series C closed in March 2026, approximately five months before review.', ['wos-c'], 'company-reported', 'High', 'Recently and substantially financed, so there is no publicly visible near term requirement. That is what this factor measures rather than company quality.'),
      outreachPotential: rate(5, 'Founder chief executive who publishes and gives detailed named interviews about the operating model, including revenue and headcount figures rarely disclosed at this stage.', ['wos-sacra'], 'company-reported', 'High', 'Unusually high founder visibility with substantive public commentary on exactly the questions a capital conversation would open with.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Exceptional disclosed capital efficiency', 'Widening product surface with acquisition appetite', 'Named adoption by leading AI application companies', 'Founder chief executive with a clear strategic thesis'], conditions: 'Subject to confirming customer concentration and contracted revenue mix. Held at 4 because a reported USD 2 billion valuation against approximately USD 30 million of ARR is a demanding entry.', provenance: 'analyst-judgment' },
      debt: { rating: 3, drivers: ['Stated ARR of approximately USD 30 million provides a recognisable base', 'Roughly 95 employees implies a cost base compatible with debt service', 'More than 1,000 customers implying limited single name concentration', 'No disclosed existing leverage'], conditions: 'Potentially suitable at a modest facility size, subject to confirming contracted ARR, gross margin, net and gross retention, burn, cash balance, and debt service capacity. The revenue per employee ratio makes the credit case more plausible here than at most companies of this scale, but it is an inference from two figures rather than a cash flow statement.', provenance: 'analyst-judgment' },
      blended: { rating: 4, drivers: ['High valuation makes equity expensive per dollar raised', 'Capital efficiency suggests genuine capacity to service interest', 'Acquisition programme suits equity while operating growth suits debt', 'Recently raised equity reduces the size any facility would need to be'], conditions: 'Subject to confirming debt service capacity and concentration. This is the clearest blended candidate in the emerging set because the efficiency evidence is quantified rather than assumed.', provenance: 'analyst-judgment' },
    },

    outreach: {
      valueProposition:
        'A company generating roughly USD 30 million of recurring revenue on about 95 people has debt service capacity that most companies at its valuation do not, which makes the mix of capital at the next event a live choice rather than a default.',
      emails: [
        {
          audience: 'CEO',
          recipientRole: 'Michael Grinich, founder and Chief Executive Officer',
          subject: 'WorkOS revenue per employee and the shape of the next raise',
          body: `Michael,

I have been researching developer infrastructure companies and which have built genuinely efficient operating models rather than efficient narratives, and WorkOS is the clearest case I have found.

Roughly USD 30 million of ARR on about 95 people is a different business shape from most companies at this valuation. It usually means the constraint is distribution rather than cash, and it changes what capital is actually for.

I would be interested in learning whether the concentration in AI application customers behaves as one cohort in practice, since that seems like the variable that matters most to how durable the base is.
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('wos-c', 'WorkOS', 'WorkOS announces USD 100M Series C led by Meritech and Sapphire', 'https://workos.com/blog', '2026-03-02', 'primary'),
      src('wos-b', 'WorkOS', 'WorkOS raises USD 80m in Series B financing, acquires Modulz', 'https://workos.com/blog/series-b', '2022-06-01', 'primary'),
      src('wos-sacra', 'Sacra', 'Michael Grinich, chief executive of WorkOS, on AI startups getting enterprise ready at launch', 'https://sacra.com/research/michael-grinich-workos-enterprise-ready-at-launch/', '2025-10-15', 'corroborating'),
      src('wos-vb', 'VentureBeat', 'WorkOS, which brings enterprise readiness to SaaS apps, raises USD 80M', 'https://venturebeat.com/programming-development/workos-which-brings-enterprise-readinessto-saas-apps-raises-80m', '2022-06-01', 'corroborating'),
    ],
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    originalSourcingSignal:
      'Financing announcement dated 16 January 2025 disclosing a USD 47 million Series B extension led by Smith Point Capital, with HSBC joining as a new investor, alongside a stated 160 percent net revenue retention for fiscal 2024.',
    discoveryChannel: 'Financing announcement',
    signalDate: '2025-01-16',
    signalFreshness: 'Established',
    whyEnteredPipeline:
      'Net revenue retention of 160 percent is disclosed. Almost no private company in this universe publishes a retention figure at all, and retention is the single metric that most determines whether a recurring revenue facility is possible. A company that volunteers it is a company that can have the conversation.',
    whyMayNeedGrowthCapital:
    ...
    whyDebtMayFit:
      'The disclosed 160 percent net revenue retention is exactly the evidence a recurring revenue lender tests first, and it is stronger than anything most companies in this universe disclose. What is missing is the revenue base to size a facility against.',
    whyBlendedMayFit:
      'Strong disclosed retention with an unknown base is the profile where a small facility alongside equity is testable quickly, because confirming one number would resolve most of the credit question.',
    preliminaryCapitalView:
      'Analyst judgment. Growth equity leads on the disclosed evidence. Private credit is potentially suitable and unusually testable, subject to confirming absolute ARR, gross margin, gross retention, burn, and debt service capacity. The retention disclosure means the hardest question is already partly answered, which is rare here.',

    outreachPriority: 'High',
    qualificationQuestions: [
      'Net revenue retention of 160 percent is disclosed for fiscal 2024 but the revenue base is not. What is absolute ARR, and how much of that expansion came from seat growth against compute consumption?',
    ...
    factors: {
      mandateFit: rate(5, 'B2B enterprise data infrastructure software sold on annual subscription to enterprise data engineering teams.', ['pr-b2'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(3, 'Eleven years of operation with strategic investment from two global banks, against no disclosed customer count, no named enterprise logos in dated primary sources, and no revenue scale.', ['pr-b2', 'pr-insight'], 'investor-reported', 'Moderate', 'Bank strategic investment is meaningful validation in a category those institutions buy in. The absence of any disclosed customer or revenue scale keeps this at the midpoint.'),
      growthQuality: rate(4, 'A stated 3.5 times revenue growth for fiscal 2024 published alongside a 160 percent net revenue retention figure, both in a dated announcement.', ['pr-b2', 'pr-sa'], 'company-reported', 'Moderate', 'Two distinct growth measures disclosed for a specific fiscal year is high quality disclosure. Held below 5 because there is no absolute base and no prior year comparison to establish durability.'),
      recurringRevenueQuality: rate(4, 'Disclosed net revenue retention of 160 percent against an annual enterprise subscription base, with growth reported in revenue rather than bookings terms.', ['pr-b2', 'pr-sa'], 'company-reported', 'Moderate', 'A disclosed retention figure is the strongest recurring revenue evidence available short of a disclosed ARR base, and almost nothing else in this universe provides it. The absent base prevents a 5.'),
      customerDurability: rate(4, 'Data transformation pipelines encode business logic and become embedded in production reporting, and the compile to open source architecture reduces the lock in customers fear while raising the migration cost once adopted.', ['pr-b2'], 'analyst-judgment', 'Moderate', 'Retention of 160 percent is direct evidence that the installed base expands rather than leaves. Held below 5 because no customer count or concentration data exists.'),
      marketAttractiveness: rate(3, 'Migration off legacy extract, transform, and load tooling is a large multi year budget, but the cloud data platforms ship competing transformation capability to the same customers.', ['pr-b2'], 'analyst-judgment', 'Moderate', 'A real and funded replacement cycle, offset by direct encroachment from the platforms the product depends on.'),
      capitalEfficiency: rate(2, 'Approximately USD 114 million of disclosed funding across eleven years with no disclosed revenue base against which to assess it.', ['pr-b2'], 'analyst-judgment', 'Limited', 'Modest capital consumption over a long operating history is weakly favourable. No revenue denominator prevents anything higher.'),
      capitalNeedTiming: rate(4, 'Nineteen months since the last disclosed round, with an enterprise migration motion that consumes capital ahead of revenue.', ['pr-b2'], 'analyst-judgment', 'Moderate', 'The elapsed time and the cost profile of long cycle enterprise selling together make a live requirement more likely than at recently financed peers.'),
      outreachPotential: rate(4, 'Founder remains chief executive after eleven years and is quoted directly in company announcements. No finance leader is publicly disclosed.', ['pr-b2'], 'company-reported', 'Moderate', 'Long tenured founder chief executive with public visibility. No disclosed finance counterparty caps this at 4.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Disclosed 160 percent net revenue retention', 'Strategic validation from two global bank investors', 'Long cycle enterprise motion requiring patient capital', 'Founder led with eleven years of category focus'], conditions: 'Subject to establishing absolute revenue scale, which determines whether the disclosed growth multiple is material.', provenance: 'analyst-judgment' },
      debt: { rating: 3, drivers: ['Disclosed net revenue retention of 160 percent, the strongest retention evidence in this universe', 'Annual enterprise subscription contract base', 'No disclosed existing leverage', 'Bank investors already familiar with the credit'], conditions: 'Potentially suitable, subject to confirming absolute ARR scale, gross retention, gross margin, burn, cash balance, and debt service capacity. Net retention above 100 percent can mask churn in a shrinking customer count, so gross retention is the specific figure that would confirm or remove this rating.', provenance: 'analyst-judgment' },
      blended: { rating: 3, drivers: ['Strong retention evidence makes a facility testable quickly', 'Valuation reference point not publicly reset since 2025', 'Defined enterprise expansion programme'], conditions: 'Subject to confirming absolute ARR and gross retention. The blended rating tracks the debt component, which is unusually close to being supportable here.', provenance: 'analyst-judgment' },
    },

    outreach: {
      valueProposition:
        'Disclosing net revenue retention publicly is rare, and it means the hardest question in a credit conversation is already half answered, which usually opens structures a company at this stage would not expect to be available.',
      emails: [
        {
          audience: 'CEO',
...
Publishing 160 percent net revenue retention is unusual. Most private companies at this stage disclose a funding total and a customer logo wall, and retention is the number that actually determines what a business is worth financing.

I would be interested in learning how much of that expansion comes from the financial services base, given that JPMorgan and HSBC are both investors and plausible buyers, and whether those contracts behave differently from the rest.
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('pr-b2', 'PR Newswire', 'Prophecy Takes in USD 47M Led by Smith Point Capital', 'https://www.prnewswire.com/news-releases/prophecy-takes-in-47m-led-by-smith-point-capital-302352647.html', '2025-01-16', 'primary', true),
      src('pr-insight', 'Insight Partners', 'Prophecy Secures USD 35M Series B Funding to Scale its Self-Service Data Transformation Platform', 'https://www.insightpartners.com/ideas/prophecy-secures-35m-series-b-funding-to-scale-its-self-service-data-transformation-platform/', '2023-10-11', 'corroborating'),
      src('pr-sa', 'SiliconANGLE', 'Prophecy raises USD 47M to automate data pipeline development with generative AI', 'https://siliconangle.com/2025/01/16/prophecy-raises-47m-automate-data-pipeline-development-generative-ai/', '2025-01-16', 'corroborating'),
      src('pr-site', 'Prophecy', 'Prophecy platform documentation and newsroom', 'https://www.prophecy.io', '2026-08-06', 'primary'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Moderate',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    factors: {
      mandateFit: rate(5, 'B2B enterprise software sold on annual subscription to finance buyers at software companies.', ['an-c'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(4, 'More than 3,000 customers, named adoption by Anthropic, Cursor, and Notion, and a stated 40 percent penetration of the Forbes AI 50.', ['an-c', 'an-bw'], 'company-reported', 'Moderate', 'Customer count and named logos are strong for a six year old company. No disclosed revenue scale prevents a 5.'),
      growthQuality: rate(2, 'Reported valuation more than doubled between the April 2024 Series B and the October 2025 Series C. No revenue or ARR growth figure has been disclosed.', ['an-c', 'an-bw'], 'investor-reported', 'Limited', 'Valuation appreciation is a price signal rather than a growth measure, and the platform volume figures disclosed alongside it do not resolve into a company growth rate.'),
      recurringRevenueQuality: rate(2, 'Annual subscription model is evidenced by the product structure. No ARR figure and no retention measure is disclosed.', ['an-c'], 'company-reported', 'Limited', 'The contract model is recurring, which earns a 2. Nothing quantifies it.'),
      customerDurability: rate(4, 'Tax compliance embeds into the billing path and the filing calendar, and unwinding it mid year creates a filing gap, which is a strong practical deterrent to switching.', ['an-c'], 'analyst-judgment', 'Moderate', 'Unusually high practical switching cost driven by the compliance calendar rather than by technical lock in. Held below 5 because no concentration data exists and the AI customer cohort is young.'),
      marketAttractiveness: rate(5, 'Economic nexus rules make the obligation automatic once revenue thresholds are crossed, so demand is created by the customer own growth rather than by a budget decision.', ['an-c'], 'analyst-judgment', 'Moderate', 'This is the strongest non discretionary demand driver in the emerging set: the purchase is triggered by law rather than by preference.'),
      capitalEfficiency: rate(2, 'More than USD 100 million of disclosed funding with no disclosed revenue against which to assess it.', ['an-c'], 'analyst-judgment', 'Limited', 'Capital raised is moderate relative to the benchmark set, bounding the potential inefficiency, but there is no denominator.'),
      capitalNeedTiming: rate(2, 'A USD 55 million Series C closed in October 2025, approximately ten months before review.', ['an-c'], 'company-reported', 'High', 'Recently and substantially financed, so no near term requirement is publicly visible.'),
      outreachPotential: rate(4, 'Founder remains chief executive and both co-founders are publicly identified. The company publishes substantive tax research under its own name.', ['an-c', 'an-org'], 'company-reported', 'Moderate', 'Founder chief executive with a public research output that supports an informed approach. No disclosed finance counterparty caps this at 4.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Non discretionary demand created by economic nexus rules', 'Named adoption across leading AI and software companies', 'International jurisdiction expansion requiring investment', 'Institutional validation from a Spark Capital led round'], conditions: 'Subject to establishing revenue scale and growth. Held at 4 because the company was recently financed, which reduces near term relevance.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['Annual subscription contract model with high practical switching cost is the only supporting condition present'], conditions: 'Not supportable on public information. No ARR, retention, gross margin, burn, or cash balance has been disclosed, and the platform volume figures describe customer revenue rather than Anrok revenue. Treating them as a proxy for scale would be an error.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['Defined international expansion requirement', 'Valuation set recently that shareholders would prefer to preserve'], conditions: 'Subject to the same evidence the debt assessment requires. The blended rating cannot exceed what the debt component can bear.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('an-c', 'Anrok', 'Anrok raises USD 55M Series C to scale global tax compliance infrastructure', 'https://www.anrok.com/resources/announcing-series-c', '2025-10-21', 'primary'),
      src('an-b', 'Anrok', 'Announcing Anrok USD 30 million Series B', 'https://www.anrok.com/resources/announcing-anroks-30-million-series-b', '2024-04-11', 'primary'),
      src('an-bw', 'Business Wire', 'Anrok Raises Series C to Bring Funding to Over USD 100 Million', 'https://www.businesswire.com/news/home/20251015978298/en/Anrok-Raises-Series-C-to-Bring-Funding-to-Over-$100-Million', '2025-10-21', 'corroborating', true),
      src('an-forbes', 'Forbes', 'Anrok Hits A USD 250 Million Valuation With A Mundane Idea: Calculating Sales Tax', 'https://www.forbes.com/sites/kenrickcai/2024/04/11/anrok-series-b-funding-250-million-valuation-sales-tax/', '2024-04-11', 'corroborating'),
      src('an-org', 'The Org', 'Michelle Valentine, chief executive and co-founder at Anrok', 'https://theorg.com/org/anrok/org-chart/michelle-valentine', '2026-08-06', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Moderate',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    signalFreshness: 'Established',
    whyEnteredPipeline:
      'A European headquartered company winning Netflix, OpenAI, and Airbnb within four years is displacing an entrenched incumbent on product rather than on price. That pattern is uncommon and it is a better predictor of durable revenue than any funding total.',
    whyMayNeedGrowthCapital:
    ...
    factors: {
      mandateFit: rate(5, 'B2B enterprise infrastructure software sold on annual subscription to engineering and reliability teams.', ['io-b'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(4, 'More than 600 customer organisations within four years, with named adoption by Netflix, Etsy, OpenAI, and Airbnb.', ['io-b', 'io-insight'], 'company-reported', 'Moderate', 'The named logo quality is exceptional for a company this young and indicates a repeatable enterprise sale. No disclosed revenue scale prevents a 5.'),
      growthQuality: rate(0, 'No quantified revenue, ARR, or customer growth figure has been disclosed at any point.', [], 'not-sufficiently-supported', 'Limited', 'Rated zero because the supporting evidence is classified as not sufficiently supported and cannot carry positive weight. There is no growth disclosure of any kind.'),
      recurringRevenueQuality: rate(2, 'Annual per responder subscription model is evidenced by the product structure. No ARR figure and no retention measure is disclosed.', ['io-b'], 'company-reported', 'Limited', 'The contract model is recurring, which earns a 2. Nothing quantifies it, and seat pricing is weaker than platform pricing for this purpose.'),
      customerDurability: rate(4, 'Incident tooling holds the on call rota, escalation policies, and post incident history, and is changed reluctantly because the migration itself creates operational risk.', ['io-b'], 'analyst-judgment', 'Moderate', 'Genuine switching cost reinforced by the risk of changing systems that are only exercised during failures. Held below 5 because no concentration data exists.'),
      marketAttractiveness: rate(4, 'Operational reliability spend grows with system complexity and carries contractual service level obligations, which makes part of it non discretionary.', ['io-b'], 'analyst-judgment', 'Moderate', 'A durable need with a contractual driver. Held below 5 because the category is crowded and an entrenched incumbent holds most existing budget.'),
      capitalEfficiency: rate(2, 'More than USD 96 million of disclosed funding with no disclosed revenue against which to assess it.', ['io-b'], 'analyst-judgment', 'Limited', 'Modest capital raised for the customer base achieved, bounding potential inefficiency, but there is no revenue denominator.'),
      capitalNeedTiming: rate(4, 'Sixteen months since the last disclosed round, competing against a public incumbent and several challengers that have financed more recently.', ['io-b'], 'analyst-judgment', 'Moderate', 'Competitive financing pressure combined with elapsed time makes a live requirement more likely here than the round size alone suggests.'),
      outreachPotential: rate(5, 'Founder chief executive who authors company announcements under his own name, with all three co-founders publicly identified and publicly associated with their prior engineering roles.', ['io-b'], 'company-reported', 'High', 'Strong founder visibility and a company that publishes substantive engineering writing, which supports a genuinely informed approach.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Named enterprise customers won against an entrenched incumbent', 'Rapid customer acquisition within four years', 'United States expansion requiring investment ahead of revenue', 'Institutional validation from an Insight Partners led round'], conditions: 'Subject to establishing ARR scale and retention, neither of which is public.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['Annual subscription contract model is the only supporting condition present'], conditions: 'Not supportable on public information. No ARR, retention, gross margin, burn, or cash balance has been disclosed. Per responder pricing also carries more exposure to customer headcount than a lender would prefer.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['Defined United States go to market expansion requirement', 'Valuation set in early 2025 that shareholders may prefer to preserve'], conditions: 'Subject to the same evidence the debt assessment requires. The blended rating cannot exceed what the debt component can bear.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('io-b', 'incident.io', 'incident.io raises USD 62M to build AI agents that resolve incidents with you', 'https://incident.io/blog/incident.io-raises-62m', '2025-04-10', 'primary'),
      src('io-site', 'incident.io', 'incident.io product and platform documentation', 'https://incident.io', '2026-08-06', 'primary'),
      src('io-insight', 'Insight Partners', 'incident.io Raises USD 62M to Build AI Agents That Resolve Incidents With You', 'https://www.insightpartners.com/ideas/incident-io-raises-62m-to-build-ai-agents-that-resolve-incidents-with-you/', '2025-04-10', 'corroborating'),
      src('io-bil', 'Built In London', 'AI Company incident.io Raises USD 62M Series B Round', 'https://builtinlondon.uk/articles/incidentio-raises-62m-series-b-20250410', '2025-04-10', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Moderate',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    financingStage: 'Series C',
    latestFinancing:
      'USD 101 million Series C led by IVP at a reported USD 605 million valuation',
    ...
    signalFreshness: 'Established',
    whyEnteredPipeline:
      'Referral intake is where provider revenue leaks, and the incumbent alternative is offshore labour rather than software. That makes the value case measurable in a way that most healthcare software cannot claim, which is a stronger foundation for underwriting than category enthusiasm.',
    whyMayNeedGrowthCapital:
    ...
    factors: {
      mandateFit: rate(5, 'B2B healthcare enterprise software sold on annual subscription to provider operations buyers.', ['tn2-pr'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(3, 'Approximately 10 million documents processed monthly and two financings within eight months, against no disclosed customer count, no named customers in dated primary sources, and no revenue scale.', ['tn2-pr', 'tn2-fortune'], 'company-reported', 'Moderate', 'Platform volume and investor quality evidence real traction. Every direct measure of customer or revenue scale is absent, which holds this at the midpoint.'),
      growthQuality: rate(2, 'Two rounds within eight months at a rising reported valuation, with stated growth in document volume. No revenue growth figure has been disclosed.', ['tn2-fortune', 'tn2-mhn'], 'investor-reported', 'Limited', 'Financing pace and platform volume are directional signals rather than growth measures, and treating valuation appreciation as growth is the substitution this framework exists to prevent.'),
      recurringRevenueQuality: rate(2, 'Annual subscription model priced on volume is evidenced by the product structure. No ARR figure and no retention measure is disclosed.', ['tn2-pr'], 'company-reported', 'Limited', 'The contract model is recurring, which earns a 2. Volume pricing without disclosed commitments prevents more.'),
      customerDurability: rate(4, 'Intake automation embeds into the referral workflow that determines provider revenue, and unwinding it returns manual volume to a team that has been resized around the software.', ['tn2-pr'], 'analyst-judgment', 'Moderate', 'Strong operational switching cost once implemented. Held below 5 because no customer count or concentration data exists and provider procurement remains price sensitive.'),
      marketAttractiveness: rate(4, 'Referral leakage is a direct revenue problem for provider organisations, and the incumbent alternative is manual labour whose cost rises rather than falls.', ['tn2-pr'], 'analyst-judgment', 'Moderate', 'A measurable financial driver rather than an efficiency claim. Held below 5 because provider margin pressure makes every purchase contested and electronic health record vendors sit adjacent.'),
      capitalEfficiency: rate(1, 'At least USD 138 million raised across two recent rounds with no disclosed revenue at any point against which to read it.', ['tn2-fortune'], 'analyst-judgment', 'Limited', 'Substantial capital raised quickly with no revenue denominator available. Rated 1 to reflect absent evidence rather than to assert inefficiency.'),
      capitalNeedTiming: rate(3, 'Fourteen months since the last disclosed round, following two financings within eight months.', ['tn2-fortune'], 'analyst-judgment', 'Moderate', 'The elapsed time creates a plausible window, but the recent financing pace suggests the company is well capitalised.'),
      outreachPotential: rate(4, 'Founder remains chief executive and all three co-founders are publicly identified. The chief executive is quoted directly in company and press announcements.', ['tn2-pr', 'tn2-fortune'], 'company-reported', 'Moderate', 'Founder chief executive access is favourable. No disclosed finance counterparty caps this at 4.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Measurable customer business case against manual labour', 'Rapid platform volume growth', 'Demonstrated access to tier one institutional capital', 'Expansion path into adjacent revenue cycle workflows'], conditions: 'Subject to establishing revenue scale and its relationship to document volume, and to a view on a reported USD 605 million valuation with no disclosed revenue.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['Annual subscription contract model with high operational switching cost is the only supporting condition present'], conditions: 'Not supportable on public information. No ARR, retention, gross margin, burn, or cash balance has been disclosed, and document volume bears no established relationship to revenue.', provenance: 'analyst-judgment' },
      blended: { rating: 1, drivers: ['No blended requirement is visible in the public record'], conditions: 'Subject to the same evidence the debt assessment requires. A company that raised twice within eight months has not signalled the dilution sensitivity that blended structures address.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('tn2-pr', 'PR Newswire', 'Healthcare referrals are where patients get lost. Tennr raises USD 101M', 'https://www.prnewswire.com/news-releases/healthcare-referrals-are-where-patients-get-lost-tennr-raises-101m-to-bring-the-visibility-our-system-desperately-needs-302485255.html', '2025-06-18', 'primary', true),
      src('tn2-site', 'Tennr', 'Tennr product and platform documentation', 'https://www.tennr.com', '2026-08-06', 'primary'),
      src('tn2-fortune', 'Fortune', 'Health tech startup Tennr raises USD 101 million Series C at USD 605 million valuation', 'https://fortune.com/2025/06/18/tennr-health-tech-ai-patient-referral-ivp-a16z-lightspeed-iconiq-series-c/', '2025-06-18', 'corroborating'),
      src('tn2-mhn', 'MobiHealthNews', 'Tennr raises USD 101M to automate referrals, hits USD 605M valuation', 'https://www.mobihealthnews.com/news/tennr-raises-101m-automate-referrals-hits-605m-valuation', '2025-06-18', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    factors: {
      mandateFit: rate(4, 'B2B enterprise risk software sold on subscription with usage components to financial institution buyers.', ['sd-c'], 'company-reported', 'High', 'Clearly enterprise software by buyer and product. Held below 5 because usage based transaction pricing sits partly outside a pure recurring software mandate.'),
      commercialMaturity: rate(4, 'A stated 2.2 billion devices profiled, a customer base that nearly doubled in 2024, and strategic investment from Moody’s Analytics and Experian Ventures.', ['sd-c', 'sd-bw'], 'company-reported', 'Moderate', 'Strategic investment from established risk data institutions is meaningful third party validation of the underlying data asset. No disclosed customer count or revenue scale prevents a 5.'),
      growthQuality: rate(3, 'A disclosed 130 percent year over year ARR growth rate for 2024, published alongside a statement that the customer base nearly doubled.', ['sd-c', 'sd-bw'], 'company-reported', 'Moderate', 'Two growth measures disclosed for a specific year is solid. Held at 3 because there is no absolute base, no prior year comparison, and the figure is now eighteen months old.'),
      recurringRevenueQuality: rate(3, 'The company reports in ARR terms and discloses an ARR growth rate against an enterprise subscription base. No absolute figure and no retention measure is published.', ['sd-c'], 'company-reported', 'Moderate', 'Reporting in ARR terms with a disclosed growth rate is more than a bare subscription claim. The absent base, absent retention, and usage components prevent a 4.'),
      customerDurability: rate(4, 'Risk decisioning embeds into transaction authorisation paths and compliance procedures that are examined by regulators, which makes replacement a governance exercise rather than a procurement one.', ['sd-c'], 'analyst-judgment', 'Moderate', 'High regulatory and operational switching cost. Held below 5 because no concentration data exists and internal build remains a live alternative at large institutions.'),
      marketAttractiveness: rate(4, 'Real time payment rails have expanded fraud exposure faster than institutions have adapted, and anti money laundering obligations make part of the spend non discretionary.', ['sd-c'], 'analyst-judgment', 'Moderate', 'A regulatory and structural driver operating together. Held below 5 because the category is crowded and large institutions retain strong internal capability.'),
      capitalEfficiency: rate(2, 'Approximately USD 145 million of disclosed funding with no absolute revenue figure against which to assess it.', ['sd-c'], 'analyst-judgment', 'Limited', 'Capital raised is moderate for the category, bounding potential inefficiency, but there is no denominator.'),
      capitalNeedTiming: rate(4, 'Eighteen months since the last disclosed round, with a financial institution sales motion that carries proof of concept costs ahead of contracted revenue.', ['sd-c'], 'analyst-judgment', 'Moderate', 'Elapsed time combined with a cost heavy enterprise motion makes a live requirement more likely than at recently financed peers.'),
      outreachPotential: rate(4, 'Founder remains chief executive, authors the company financing announcement under his own name, and all three co-founders are publicly identified.', ['sd-c'], 'company-reported', 'Moderate', 'Founder chief executive who writes publicly, which supports an informed approach. No disclosed finance counterparty caps this at 4.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Disclosed 130 percent ARR growth for 2024', 'Strategic validation from two established risk data institutions', 'Regulatory and real time payment fraud tailwinds', 'Expansion path from fraud into credit decisioning'], conditions: 'Subject to establishing absolute revenue scale and the durability of the disclosed growth rate eighteen months on.', provenance: 'analyst-judgment' },
      debt: { rating: 2, drivers: ['Disclosed ARR growth against an enterprise subscription base', 'High regulatory switching cost supporting revenue durability', 'No disclosed existing leverage'], conditions: 'Potentially suitable, subject to confirming absolute ARR scale, the committed against usage revenue split, gross margin, net and gross retention, burn, and debt service capacity. The company discloses a growth rate but not the base, so no facility could be sized from public information.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['Defined enterprise expansion requirement', 'Valuation not publicly reset since early 2025'], conditions: 'Subject to confirming absolute ARR and debt service capacity. The blended rating tracks the debt component.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('sd-c', 'Sardine', 'Sardine USD 70M Funding: Innovating Financial Fraud Protection', 'https://www.sardine.ai/blog/series-c-announcement', '2025-02-11', 'primary'),
      src('sd-bw', 'Business Wire', 'Sardine AI Raises USD 70M to Make Fraud and Compliance Teams More Productive', 'https://www.businesswire.com/news/home/20250211169372/en/Sardine-AI-Raises-$70M-to-Make-Fraud-and-Compliance-Teams-More-Productive', '2025-02-11', 'corroborating', true),
      src('sd-finextra', 'Finextra', 'Sardine raises USD 70m for AI fraud platform', 'https://www.finextra.com/newsarticle/45484/sardine-raises-70m-for-ai-fraud-platform', '2025-02-11', 'corroborating'),
      src('sd-contrary', 'Contrary Research', 'Sardine business breakdown and founding story', 'https://research.contrary.com/company/sardine', '2025-06-01', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Moderate',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    factors: {
      mandateFit: rate(5, 'B2B vertical enterprise software sold on annual per seat subscription to talent and recruiting operations buyers.', ['ab-d'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(4, 'Named adoption by Shopify, Snowflake, OpenAI, Ramp, Notion, and Cursor, with a customer base that more than doubled over the year to July 2025.', ['ab-d', 'ab-cb'], 'company-reported', 'Moderate', 'The named logo list spans both enterprise and high growth cohorts, which is stronger evidence than either alone. No disclosed revenue scale or customer count prevents a 5.'),
      growthQuality: rate(3, 'A disclosed 135 percent ARR increase over the year to July 2025, published alongside a statement that the customer base more than doubled.', ['ab-d', 'ab-cb'], 'company-reported', 'Moderate', 'Two growth measures for a defined period is solid disclosure. Held at 3 because there is no absolute base, no multi period series, and the figure is a year old.'),
      recurringRevenueQuality: rate(3, 'The company reports in ARR terms with a disclosed growth rate against a per seat annual subscription base. No absolute figure and no retention measure is published.', ['ab-d'], 'company-reported', 'Moderate', 'ARR framing with a disclosed rate lifts this above a bare subscription claim. The absent base and absent retention prevent a 4.'),
      customerDurability: rate(3, 'Applicant tracking systems hold candidate history and hiring records and are replaced infrequently, but the category sees more displacement than infrastructure software and pricing is tied to customer headcount.', ['ab-d'], 'analyst-judgment', 'Moderate', 'Real switching cost offset by a cyclical revenue base and by a category where replacement projects are routine rather than exceptional.'),
      marketAttractiveness: rate(3, 'Recruiting software is a large established category, and demand moves directly with hiring volume rather than with a structural driver.', ['ab-d'], 'analyst-judgment', 'Moderate', 'Sizeable market undermined by procyclicality. Spend contracts precisely when a lender would most want stability.'),
      capitalEfficiency: rate(3, 'Approximately USD 100 million of disclosed funding across eight years, modest relative to the benchmark set, with no absolute revenue figure against which to read it.', ['ab-d'], 'analyst-judgment', 'Limited', 'Low absolute capital consumption over a long period is genuinely suggestive of discipline, which lifts this above peers with larger raises and no disclosure. No denominator prevents more.'),
      capitalNeedTiming: rate(3, 'Twelve months since the last disclosed round, with an upmarket transition underway against well capitalised incumbents.', ['ab-d'], 'analyst-judgment', 'Moderate', 'A credible investment programme with a recent round behind it, which is the definition of a middling rating on this factor.'),
      outreachPotential: rate(4, 'Founder remains chief executive and is quoted directly on strategy in financing coverage, with both co-founders publicly identified.', ['ab-d', 'ab-cb'], 'company-reported', 'Moderate', 'Founder chief executive access is favourable. No disclosed finance counterparty caps this at 4.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Disclosed 135 percent ARR growth', 'Named customers across enterprise and high growth cohorts', 'Upmarket transition requiring go to market investment', 'Modest historical capital consumption'], conditions: 'Subject to establishing absolute revenue scale and how the base behaved through the last hiring contraction.', provenance: 'analyst-judgment' },
      debt: { rating: 2, drivers: ['Disclosed ARR growth against a subscription contract base', 'Long operating history with modest capital raised', 'No disclosed existing leverage'], conditions: 'Potentially suitable, subject to confirming absolute ARR scale, gross margin, net and gross retention, burn, and debt service capacity. Per seat pricing tied to customer hiring is among the more cyclical revenue profiles in enterprise software, so downside behaviour would need specific attention before any facility.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['Defined upmarket expansion requirement', 'Valuation set in mid 2025 that shareholders may prefer to preserve'], conditions: 'Subject to confirming absolute ARR and downside revenue behaviour. The blended rating tracks the debt component, which is constrained by revenue cyclicality rather than only by disclosure.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('ab-d', 'The SaaS News', 'Ashby Raises USD 50 Million in Series D', 'https://www.thesaasnews.com/news/ashby-raises-50-million-in-series-d/', '2025-07-23', 'primary'),
      src('ab-site', 'Ashby', 'Ashby product and platform documentation', 'https://www.ashbyhq.com', '2026-08-06', 'primary'),
      src('ab-cb', 'Crunchbase News', 'AI powered HR platform Ashby raises USD 50M', 'https://news.crunchbase.com/venture/ai-powered-hr-platform-ashby-raise/', '2025-07-23', 'corroborating'),
      src('ab-ab', 'American Bazaar', 'AI hiring platform Ashby secures USD 50 million to streamline recruitment', 'https://americanbazaaronline.com/2025/07/23/ai-hiring-platform-ashby-secures-50-million-to-streamline-recruitment-465454/', '2025-07-23', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Moderate',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    factors: {
      mandateFit: rate(5, 'B2B enterprise infrastructure software sold on per user subscription to platform engineering and security buyers.', ['ts-c'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(4, 'A stated 10,000 customer base with named adoption by SAP, Motorola, Telus, Instacart, and several leading AI infrastructure companies.', ['ts-c', 'ts-pcj'], 'company-reported', 'Moderate', 'The named logo breadth across traditional enterprise and frontier AI companies is strong evidence of a product that sells across buying cultures. No disclosed revenue scale prevents a 5.'),
      growthQuality: rate(0, 'No quantified revenue, ARR, or customer growth figure has been disclosed by the company at any point.', [], 'not-sufficiently-supported', 'Limited', 'Rated zero because the supporting evidence is classified as not sufficiently supported and cannot carry positive weight. Press characterisations of surprising growth are not a growth disclosure.'),
      recurringRevenueQuality: rate(2, 'Per user subscription model is evidenced by the product structure. No ARR figure and no retention measure is disclosed.', ['ts-c'], 'company-reported', 'Limited', 'The contract model is recurring, which earns a 2. Nothing quantifies it, and the free tier means user counts are not revenue.'),
      customerDurability: rate(4, 'Network connectivity embeds into production infrastructure and access policy, and replacing it requires re establishing connectivity for every device and service.', ['ts-c'], 'analyst-judgment', 'Moderate', 'Very high technical switching cost once deployed across an estate. Held below 5 because the open source components allow a sophisticated customer to self host the parts it values most.'),
      marketAttractiveness: rate(4, 'Zero trust network access is replacing perimeter virtual private networks across the enterprise, and distributed AI workloads have added a new driver of demand for direct connectivity.', ['ts-c'], 'analyst-judgment', 'Moderate', 'A genuine architectural replacement cycle with a new workload driver. Held below 5 because the category includes very well capitalised incumbents selling into existing security budgets.'),
      capitalEfficiency: rate(0, 'Approximately USD 275 million reported raised with no disclosed revenue figure of any kind against which to assess it.', [], 'not-sufficiently-supported', 'Limited', 'Rated zero because the supporting evidence is classified as not sufficiently supported and cannot carry positive weight. Substantial capital raised with no revenue disclosure means no efficiency judgment is possible.'),
      capitalNeedTiming: rate(3, 'Sixteen months since the last disclosed round, with a stated intention to grow as a private company toward an eventual listing.', ['ts-c', 'ts-betakit'], 'analyst-judgment', 'Moderate', 'The elapsed time and the stated listing ambition create a plausible window, though a USD 160 million round provides substantial runway.'),
      outreachPotential: rate(5, 'Founder chief executive who authors the company financing announcements personally and publishes extensively and technically under his own name, with all three co-founders publicly identified.', ['ts-c'], 'company-reported', 'High', 'Exceptional founder visibility with a long public writing record on exactly the architectural questions a capital conversation would engage.'),
    },

    capitalFit: {
      equity: { rating: 4, drivers: ['Named customer breadth across enterprise and frontier AI companies', 'Architectural replacement cycle in zero trust access', 'Demonstrated repeated access to institutional capital', 'Stated intention to build toward an eventual public listing'], conditions: 'Subject to establishing revenue scale and free to paid conversion economics, neither of which is public.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['Per user subscription contract model with high switching cost is the only supporting condition present'], conditions: 'Not supportable on public information. No revenue figure has ever been disclosed, and the company explicitly structured its most recent round as all equity, which indicates limited appetite independently of the evidence gap.', provenance: 'analyst-judgment' },
      blended: { rating: 1, drivers: ['No blended requirement is visible in the public record'], conditions: 'Subject to the same evidence the debt assessment requires. An explicitly all equity most recent round is the opposite of the dilution sensitivity a blended structure addresses.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('ts-c', 'Tailscale', 'Tailscale raises USD 160 Million Series C to build the New Internet', 'https://tailscale.com/blog/series-c', '2025-04-08', 'primary'),
      src('ts-site', 'Tailscale', 'Tailscale product and platform documentation', 'https://tailscale.com', '2026-08-06', 'primary'),
      src('ts-betakit', 'BetaKit', 'Corporate VPN startup Tailscale secures USD 230 million CAD Series C on back of surprising growth', 'https://betakit.com/corporate-vpn-startup-tailscale-secures-230-million-cad-series-c-on-back-of-surprising-growth/', '2025-04-08', 'corroborating'),
      src('ts-pcj', 'Private Capital Journal', 'Tailscale secures US USD 160M Series C', 'https://privatecapitaljournal.com/tailscale-secures-us-160m-series-c/', '2025-04-09', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Limited',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    signalFreshness: 'Established',
    whyEnteredPipeline:
      'A two sided network in an insurance workflow that neither carriers nor brokers can build alone is a structurally defensible position that rarely appears in growth software screens. It entered the pipeline as a deliberate search for that shape rather than for a growth rate.',
    whyMayNeedGrowthCapital:
    ...
    factors: {
      mandateFit: rate(5, 'B2B vertical enterprise software sold on annual subscription to insurance brokers and carriers.', ['tf-site'], 'company-reported', 'High', 'Product, buyer, and revenue model are squarely enterprise software.'),
      commercialMaturity: rate(3, 'Eleven years of operation with three disclosed rounds and a Series C led by a specialist vertical software investor, against no disclosed customer count, named customers, or revenue scale.', ['tf-cb', 'tf-2023'], 'investor-reported', 'Limited', 'Longevity and investor quality are the only maturity evidence available. Every direct measure this factor asks for is absent.'),
      growthQuality: rate(0, 'No quantified revenue, ARR, or customer growth figure has been disclosed at any point.', [], 'not-sufficiently-supported', 'Limited', 'Rated zero because the supporting evidence is classified as not sufficiently supported and cannot carry positive weight.'),
      recurringRevenueQuality: rate(2, 'Annual subscription model on both sides of the network is evidenced by the product structure. No ARR figure and no retention measure is disclosed.', ['tf-site'], 'company-reported', 'Limited', 'The contract model is recurring, which earns a 2. Nothing quantifies it.'),
      customerDurability: rate(5, 'A two sided placement network becomes the shared record between brokers and carriers, so leaving requires the counterparty to leave as well. That is the highest structural switching cost available to enterprise software.', ['tf-site'], 'analyst-judgment', 'Moderate', 'Network effects across counterparties who must transact with each other produce durability that single sided software cannot match, and it is the specific reason this company is in the universe.'),
      marketAttractiveness: rate(3, 'Employee benefits placement is a large and non discretionary annual process, but the software budget is small relative to the premium flowing through it and the buying side is fragmented.', ['tf-site'], 'analyst-judgment', 'Moderate', 'Durable underlying process with a constrained software budget and a slow moving, fragmented buyer base.'),
      capitalEfficiency: rate(3, 'Approximately USD 83 million of disclosed funding across eleven years, modest for the operating history, with a last round led by a growth equity investor.', ['tf-cb'], 'analyst-judgment', 'Limited', 'Low capital consumption over a long period is genuinely suggestive of discipline. No revenue denominator prevents anything higher.'),
      capitalNeedTiming: rate(4, 'Nearly three years since the last disclosed round, the longest financing gap in the emerging set, from a company that had previously raised roughly every two years.', ['tf-cb'], 'analyst-judgment', 'Moderate', 'A break in an established financing cadence is a specific signal, and it makes a live conversation more likely here than the absence of other news would suggest.'),
      outreachPotential: rate(3, 'Founder remains chief executive after eleven years and all three co-founders are publicly identified. Public commentary on strategy is limited and no finance leader is disclosed.', ['tf-cb'], 'analyst-judgment', 'Limited', 'Founder continuity is favourable but public visibility is the lowest in the emerging set, and there is no disclosed finance counterparty.'),
    },

    capitalFit: {
      equity: { rating: 3, drivers: ['Structurally defensible two sided network position', 'Eleven year operating history with modest capital consumption', 'Longest financing gap in the set, suggesting a live conversation'], conditions: 'Subject to establishing current revenue scale and growth, neither of which is public. The rating reflects unverifiable current performance rather than a negative view of the network position.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['Annual subscription contract model with exceptional network switching cost is the only supporting condition present'], conditions: 'Not supportable on public information. No ARR, retention, gross margin, burn, or cash balance has been disclosed at any point. Strong structural durability is not a substitute for the financial evidence a credit assessment requires.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['Long operating history with modest capital raised suggests the business may be closer to breakeven than its stage implies', 'Valuation reference point set in 2023 that shareholders may prefer not to reset'], conditions: 'Subject to the same evidence the debt assessment requires. The blended rating cannot exceed what the debt component can bear.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('tf-site', 'ThreeFlow', 'ThreeFlow software for benefits brokers and carriers', 'https://www.threeflow.com/', '2026-08-06', 'primary'),
      src('tf-2023', 'ThreeFlow', 'Reflecting on ThreeFlow growth in 2023', 'https://www.threeflow.com/post/reflecting-on-threeflows-growth-in-2023', '2024-01-15', 'primary'),
      src('tf-tc', 'TechCrunch', 'ThreeFlow raises USD 45 million to scale its employee benefits placement software', 'https://techcrunch.com/2021/11/30/threeflow-raises-45-million-to-scale-its-employee-benefits-placement-software/', '2021-11-30', 'corroborating'),
      src('tf-cb', 'Crunchbase News', 'Employee benefits company WatchTower becomes ThreeFlow', 'https://news.crunchbase.com/startups/exclusive-watchtower-becomes-threeflow-raises-8m-series-a/', '2020-06-16', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Limited',
    privateStatusVerification: claim(
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    financingStage: 'Series B',
    latestFinancing:
      'USD 57 million Series B co-led by Insight Partners and Canapi Ventures',
    ...
    signalFreshness: 'Established',
    whyEnteredPipeline:
      'Four years without a disclosed round, in a category where competitors have raised repeatedly, usually means one of two things: the business is self funding or it is constrained. Both are worth establishing, and the answer determines everything about which conversation is appropriate.',
    whyMayNeedGrowthCapital:
    ...
    factors: {
      mandateFit: rate(4, 'B2B financial technology infrastructure sold to risk and compliance buyers, with usage based rather than subscription economics.', ['md-site'], 'company-reported', 'Moderate', 'Clearly enterprise software by buyer and product. Held below 5 because per verification pricing sits partly outside a recurring software mandate.'),
      commercialMaturity: rate(3, 'Independent recognition on the Fast Company Most Innovative Companies list for 2025 and eight years of operation, against no disclosed customer count, named customers, or revenue scale.', ['md-fc', 'md-b'], 'independently-verified', 'Limited', 'Independent recognition is real third party validation, which holds this at the midpoint. Every direct measure of scale is absent.'),
      growthQuality: rate(0, 'No quantified revenue, ARR, or customer growth figure has been disclosed at any point.', [], 'not-sufficiently-supported', 'Limited', 'Rated zero because the supporting evidence is classified as not sufficiently supported and cannot carry positive weight.'),
      recurringRevenueQuality: rate(1, 'Revenue is usage based per verification and per filing rather than contracted subscription. No revenue figure and no retention measure is disclosed.', ['md-site'], 'analyst-judgment', 'Limited', 'Usage based verification revenue does not earn the baseline credit given to a subscription contract model, because it repeats only with customer activity.'),
      customerDurability: rate(4, 'Verification providers embed into onboarding flows and compliance procedures that are examined by regulators, so replacement requires re validating the control rather than swapping a vendor.', ['md-site'], 'analyst-judgment', 'Limited', 'High regulatory switching cost. Held below 5 because no customer data exists and incumbent bureau relationships remain in place alongside.'),
      marketAttractiveness: rate(4, 'Know your business obligations are regulatory rather than discretionary, and business to business platforms increasingly face the same requirements banks do.', ['md-site'], 'analyst-judgment', 'Moderate', 'A genuine regulatory driver expanding to new buyer types. Held below 5 because entrenched bureaus hold the existing budget.'),
      capitalEfficiency: rate(3, 'Approximately USD 77 million of disclosed funding across eight years, the lowest total in the emerging set, with four years since the last disclosed round.', ['md-b'], 'analyst-judgment', 'Limited', 'Operating four years without disclosed external capital is real circumstantial evidence of discipline, which is why this is not lower. No revenue denominator prevents more.'),
      capitalNeedTiming: rate(5, 'Four years since the last disclosed financing, the longest gap in the entire universe, in a category where direct competitors have raised repeatedly over the same period.', ['md-b', 'md-fc'], 'analyst-judgment', 'Moderate', 'This is the anchor case for a high rating on this factor. A four year gap against active competitor financing means the capital question is live in one direction or the other.'),
      outreachPotential: rate(3, 'Founder remains chief executive after eight years and both co-founders are publicly identified. Public commentary on strategy is limited and no finance leader is disclosed.', ['md-site'], 'analyst-judgment', 'Limited', 'Founder continuity is favourable but public visibility is low and there is no disclosed finance counterparty.'),
    },

    capitalFit: {
      equity: { rating: 3, drivers: ['Regulatory demand driver expanding to new buyer types', 'Lowest capital consumption in the emerging set', 'Independent industry recognition', 'Four year financing gap suggesting a live conversation'], conditions: 'Subject to establishing current revenue scale and whether the financing gap reflects sustainability or constraint. Those are very different companies and the public record cannot distinguish them.', provenance: 'analyst-judgment' },
      debt: { rating: 1, drivers: ['High regulatory switching cost supporting customer persistence is the only meaningful supporting condition'], conditions: 'Not supportable on public information, and the usage based pricing model argues against a recurring revenue facility independently. Per verification revenue tracks customer onboarding volume rather than contracted minimums, which is the profile lenders discount most.', provenance: 'analyst-judgment' },
      blended: { rating: 2, drivers: ['A runway extension need, if one exists, could suit a mixed instrument', 'Valuation set in 2022 that shareholders would prefer not to reset'], conditions: 'Subject to establishing revenue scale and the committed revenue share. The blended rating cannot exceed what the debt component can bear.', provenance: 'analyst-judgment' },
    },
...
modi.sahil@gmail.com`,
    ...
    sources: [
      src('md-site', 'Middesk', 'Middesk business identity platform documentation', 'https://www.middesk.com', '2026-08-06', 'primary'),
      src('md-fc', 'Middesk', 'Middesk named a 2025 Fast Company World’s Most Innovative Company', 'https://www.middesk.com/blog/middesk-named-a-2025-fast-company-worlds-most-innovative-company', '2025-03-18', 'primary'),
      src('md-b', 'PR Newswire', 'Leading business identity platform Middesk raises USD 57M Series B', 'https://www.prnewswire.com/news-releases/leading-business-identity-platform-middesk-raises-57m-series-b-co-led-by-insight-partners-and-canapi-ventures-301561620.html', '2022-06-09', 'corroborating', true),
      src('md-tc', 'TechCrunch', 'Middesk raises USD 57M to automate business verification and underwriting', 'https://techcrunch.com/2022/06/09/middesk-raises-57m/', '2022-06-09', 'corroborating'),
    ],
    lastReviewed: REVIEW_DATE,
    dataConfidence: 'Limited',
    privateStatusVerification: claim(
